...
RESOURCES	= main.c canvas.c input.c output.c
...
$(NAME): $(OBJ_PFIX)
	...
	@make -C $(LFT_PATH)
	@make -C $(MLX_PATH)
	@$(CC) -o $(NAME) $(OBJ_PFIX) -lm -L $(LFT_PATH) -lm -L $(MLX_PATH) -lft $(FRAMWRKS)
	@echo "$(OKC)FDF ready$(NOC)"
...
clean:
	...
	@rm -rf $(OBJ_PATH)
	@echo "$(WAC)Removing FDF OBJECTS path$(NOC)"

fclean: clean
	@make -C $(LFT_PATH) fclean
	@make -C $(MLX_PATH) clean
	@rm -f $(NAME)
	@echo "$(WAC)Removing FDF executable$(NOC)"
